...
try {
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (
            ...
            $query = "INSERT INTO material_monitoring_sheet (department, laboratory, date, accountable_person, qty, unit, description, po_number, account_code, account_name, tag_number, acquisition_date, location, unit_price, total, remarks, mr_number)
                      VALUES (:department, :laboratory, :date, :accountable_person, :qty, :unit, :description, :po_number, :account_code, :account_name, :tag_number, :acquisition_date, :location, :unit_price, :total, :remarks, :mr_number)";
            ...
            if ($stmt->execute()) {
                ...
                echo json_encode(['success' => false, 'message' => 'Material sheet could not be added.']);
            }
        } else {
